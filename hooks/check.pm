package Genesis::Hook::Check::Blacksmith v3.0.0;
...
# check_certificates - Validate certificate requirements {{{
...
# check_runtime_config - Validate runtime configuration {{{
...
# check_feature_compatibility - Validate feature combinations {{{
